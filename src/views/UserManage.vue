<template>
  <div class="user-management">
    <el-table :data="users" v-loading="this.$store.state.isLoading" style="width: 100%">
      <el-table-column prop="id" label="ID" sortable></el-table-column>
      <el-table-column prop="username" label="用户名" sortable></el-table-column>
      <el-table-column prop="email" label="邮箱" sortable></el-table-column>
      <el-table-column prop="phone" label="手机号" sortable></el-table-column>
      <el-table-column prop="address" label="地址" sortable></el-table-column>
      <el-table-column prop="isEnabled" label="状态" sortable>
      ...
      <el-table-column label="Actions">
        <template slot-scope="scope">
          ...
          <el-button v-if="scope.row.isEnabled" @click="blacklistUser(scope.row.id)" type="danger" size="mini">拉黑用户</el-button>
          <el-button v-if="!scope.row.isEnabled" @click="unblockUser(scope.row.id)" type="danger" size="mini">解除拉黑</el-button>
        </template>
      </el-table-column>
    </el-table>
